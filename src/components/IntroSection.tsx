...
function IntroSection() {
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="w-[350] font-medium text-3xl text-[#EEEFEF] text-center">
        <span className="text-[#7873FF]">TRADE </span>
        YOUR FAVORITE MARKET
      </div>
      <div>
        <p className="text-[#74757C] text-center w-sm text-sm">Want to buy Bitcoin outright or trade CFDs on Gold or EUR/USD? We've got you covered with access to 100+ global markets on one platform.</p>
      </div>
